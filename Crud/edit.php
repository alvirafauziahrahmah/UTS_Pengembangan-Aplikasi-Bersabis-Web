<?php include('config.php'); ?>
	...
	<div class="container" style="margin-top:20px">
		...
		if(isset($_GET['Nim'])){
			...
			$select = mysqli_query($koneksi, "SELECT * FROM user WHERE NIP='$NIP'") or die(mysqli_error($koneksi));
		...
		if(isset($_POST['submit'])){
			...
			$sql = mysqli_query($koneksi, "UPDATE guru SET nama_guru='$nama_guru', jenis_kelamin='$jenis_kelamin', mata_pelajaran='$mata_pelajaran' WHERE NIP='$NIP'") or die(mysqli_error($koneksi));
